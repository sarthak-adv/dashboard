...
import { COLORS, ATTRITION_HEATMAP, ORG_TREE, KEYWORDS } from '../data';
import { Delta } from './Shell';
...
function ManagerTab({ survey }) {
  const [selectedTheme, setSelectedTheme] = useState('pwe');
  const [chartType, setChartType] = useState('All Data');
