...
import { COLORS, LEADERS, CALL_SLOTS, SURVEYS, SURVEY_ORDER, CONVERSATIONS } from '../data';
...
function ComposeScreen() {
  ...
  const [functionF, setFunctionF] = useState('All');
  const [locationF, setLocationF] = useState('All');
  const [anonMode, setAnonMode] = useState(null);
...
function InboxScreen() {
  ...
  useEffect(() => { setAcceptedSlot(null); setReply(''); }, [activeId]);
...
export { ComposeScreen, InboxScreen };