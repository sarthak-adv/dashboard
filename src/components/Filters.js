...
import { COLORS, SURVEYS, SURVEY_ORDER } from '../data';
...
export const ANONYMITY_GATED_TABS = new Set(['sentiment', 'engagement', 'manager', 'attrition']);
...
export {
  SurveySelector, FilterBar, AnonymityGate, TabStrip,
};