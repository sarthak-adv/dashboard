...
function App() {
  ...
  const [expanded, setExpanded] = React.useState({ survey: true, connect: true });

  const [surveyKey, setSurveyKey] = React.useState('oct-2025-pulse');
  ...
  React.useEffect(() => { setActiveTab('overview'); }, [surveyKey]);
